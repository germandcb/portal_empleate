...
public class MenuAspirante extends JFrame{
    ...
    public JPanel panelLeft() {
		...
		// BOTON DE POSTULACIONES
        JLabel jlbPostulacion = new JLabel("Mis Postulaciones");
        jlbPostulacion.setBounds(0,0,180,45);
        jlbPostulacion.setForeground(Color.white);
        jlbPostulacion.setHorizontalAlignment(SwingConstants.CENTER);
        jlbPostulacion.setFont(new Font("Berlin Sans FB", Font.PLAIN, 20));
        
        JPanel btnPostulacion = new JPanel();
        btnPostulacion.setBackground(new Color(25,44,60));
        btnPostulacion.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnPostulacion.setBackground(new Color(16,15,15));
			}
        ...
        btnPostulacion.setBounds(40, 295, 180, 45);
        btnPostulacion.setLayout(null);
        btnPostulacion.setCursor(new Cursor(Cursor.HAND_CURSOR));
        btnPostulacion.add(jlbPostulacion);	
		panelLeft.add(btnPostulacion);
		
		// BOTON DE CREAR OFERTA
        JLabel jlbBuscarOferta = new JLabel("Buscar Oferta");
        jlbBuscarOferta.setBounds(0,0,180,45);
        jlbBuscarOferta.setForeground(Color.white);
        jlbBuscarOferta.setHorizontalAlignment(SwingConstants.CENTER);
        jlbBuscarOferta.setFont(new Font("Berlin Sans FB", Font.PLAIN, 20));
        
        JPanel btnBuscarOferta = new JPanel();
        btnBuscarOferta.setBackground(new Color(25,44,60));
        btnBuscarOferta.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBuscarOferta.setBackground(new Color(16,15,15));
			}
        ...
        btnBuscarOferta.setBounds(40, 350, 180, 45);
        btnBuscarOferta.setLayout(null);
        btnBuscarOferta.setCursor(new Cursor(Cursor.HAND_CURSOR));
        btnBuscarOferta.add(jlbBuscarOferta);	
		panelLeft.add(btnBuscarOferta);
    ...
    public JPanel panelRigth() {
        ...
        String textoDescripcion = "<html><body> <p center>Bienvenido al sistema EMPLEATE <br> Desde aquí usted podrá postularse a diferentes ofetas de trabajo y mirar el proceso de contratacionr.</p></html></body> ";
        ...
        String textoDescripcion_1 = "<html><body>  - Perfil: Es la informacion o datos  de la cuenta del empleador y de la emplesa. <br>"
        		+ " - Mis Publicaciones: Son las publicaciones en las que el usuario se ha postulado <br>"
        		+ " - Buscar Ofertas: Ventana que le muestra y lista todas las publicaciones que existen en empleate <br> </html></body> ";
