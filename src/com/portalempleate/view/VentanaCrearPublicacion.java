...
public class VentanaCrearPublicacion extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFrame frame = new VentanaCrearPublicacion();
	...
	public JPanel panelForm() {
		...
		JLabel labelTitleLogin = new JLabel("Crear Publicacion");
		...
		//BOTON DE REGISTRAR
		JLabel lblRegistrar = new JLabel("Registrar Publicacion");
		...
		btnRegistrar.setBackground(new Color(50,89,119));
		btnRegistrar.addMouseListener(
			new MouseAdapter() {
				@Override
				public void mouseEntered(MouseEvent e) {
					btnRegistrar.setBackground(new Color(68,116,148));
				}
		...
		btnRegistrar.setBounds(285, 460, 230, 50);
